        ...
        {activeTab === 'admin' && currentUser && currentUser.role === 'admin' && (() => {
          ...
          return (
            <div className="animate-fade-in">
              ...
              <div className="admin-subnav">
                ...
                <div className="nav-tabs">
                  <button
                    className={`nav-tab-btn ${adminSubTab === 'dashboard' ? 'active' : ''}`}
                    onClick={() => setAdminSubTab('dashboard')}
                  >
                    <svg style={{ width: '14px', height: '14px' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
                    Inventory & Batches
                  </button>
                  <button
                    className={`nav-tab-btn ${adminSubTab === 'analytics' ? 'active' : ''}`}
                    onClick={() => setAdminSubTab('analytics')}
                  >
                    <svg style={{ width: '14px', height: '14px' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line><line x1="2" y1="20" x2="22" y2="20"></line></svg>
              ...
              <div 
                ...
                onClick={() => document.getElementById('customer-orders-section')?.scrollIntoView({ behavior: 'smooth' })}
              >
                <div>
              ...
              <div 
                ...
                onClick={() => document.getElementById('batches-catalog-section')?.scrollIntoView({ behavior: 'smooth' })}
              >
                <div>
              ...
              <div 
                ...
                onClick={() => document.getElementById('priority-alerts-section')?.scrollIntoView({ behavior: 'smooth' })}
              >
                <div>
            ...
            <div className="dashboard-sections">
              ...
              {/* Left Column: Form & Inventory Tables */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                ...
                {/* 2. Raw Ingredients Inventory & Refill */}
                <div className="glass-card">
              ...
              {/* Right Column: Visual Alert Center & Analytics */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                
                {/* 1. Visual Alert Center: Expiry Calendar */}
                <div className="glass-card">
                ...
                {/* 4. Downstream Whatsapp API logs */}
                <div className="glass-card">
            ...
            {/* 3. Customer Orders View (Full Width) */}
            ...
            {/* 4. Complete Batch Catalog Table (Bottom of admin) */}
